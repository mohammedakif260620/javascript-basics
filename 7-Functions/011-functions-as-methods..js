...
const user = {
  ...
  // go through once below some shoutcuts of 34 35 37 38 line's where we can directly execute output 

  console.log(`${user.company.location}`);

  console.log(`openly calling the object items  ${user.company.location}`);
  
  console.log(`openly calling the object items => ${user.company.location}`);

  console.log(`${user['company']['location']}`);

  console.log(`OPENLY calling through bracket notattion ${user['company']['location']}`);
